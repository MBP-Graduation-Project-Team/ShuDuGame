...
public class GameActivity extends AppCompatActivity {
    ...
    private int level;
    /** 耗时 **/
    private int time = MapUtil.getTime();
    ...
    private void startTime(){
        ...
        timerTask = new TimerTask() {
            @Override
            public void run() {
                MapUtil.setTime(time);
                runOnUiThread(() -> timeShow.setText(timeUtil.getStringTime(time++)));
            }
        };
     ...
     * @param level 关卡编号
     */
    public void getSpeedGameMap(int level){
